        ...
        <div class="flex-grid no-responsive-future" style="height: 100%;">
            <div class="row" style="height: 100%">
                ...
                <div class="cell auto-size padding20 bg-white" id="cell-content">
                    <h1 class="text-light"><a href="{{ ('admin/str') }}" class="nav-button transform"><span></span></a> DATA JENIS KUE</h1>
                    <hr class="thin bg-grayLighter">
                    <table class="dataTable border bordered" data-role="datatable" data-auto-width="false">
                        <thead>
                        <tr>
                            
                            <td class="sortable-column"><center>ID</center></td>
                            <td class="sortable-column"><center>Jenis Kue</center></td>
                            <td class="sortable-column"><center>Aksi</center></td>
                        </tr>
                        </thead>
                        <tbody>
                        <tr>
                            
                            <td class="sortable-column"><center></center></td>
                            <td class="sortable-column"><center><center></td>
                            <td><center>
                                <a href="" class="btny biru">
                                <font color="white">Ubah</font></a>
                                <a href="" class="btny biru" 
                                onclick="javascript: return confirm('Apakah anda yakin akan menghapus ?')"> 
                                <font color="white">Hapus</font></a></center></td>
                        </tr>
                        </tr>
                        </tbody>
                    </table>
