...
<body onLoad="window.print()" class="bg-steel">
    <div class="app-bar fixed-top darcula" data-role="appbar" style="background-color:#d6d4d4; box-shadow:0 5px 10px grey; height:11%;">
        <br><center><img src="metro/images/report.png"></center>
        ...
        <div class="flex-grid no-responsive-future" style="height: 100%;">
                ...
                <div class="cell auto-size padding20 bg-white" id="cell-content"><br><br><br><br>
                    <table class="dataTable border bordered">
                        ...
                        <tr>
                            ...
                            <td class="sortable-column">Jenis Jaket</td>
            ...
            ?>
                        <tr>
                            ...
                            <td class="sortable-column"><?php echo $key['nm_pemesan'];?></td>
                            <td class="sortable-column"><?php echo $key['no_telp'];?></td>
                            <td class="sortable-column"><?php echo $key['jmlh_pesanan'];?></td>
                            <td class="sortable-column"><?php echo $key['jenis_jkt'];?></td>
                            <td class="sortable-column"><?php echo $key['ukuran'];?></td>
                            <td class="sortable-column"><?php echo $key['gambar'];?></td>
